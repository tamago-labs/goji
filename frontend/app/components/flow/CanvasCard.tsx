  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-3 pb-2">
        <span className={`text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded ${colors.badge} ${colors.badgeText}`}>
          {card.category}
        </span>
      </div>
      ...
      <div className="px-4 pb-3">
        ...
        {card.category === "wallet" && (
          <>
            ...
            <div className="text-mint text-xs font-medium mt-1">{card.fields.balance || "$0"} USDC</div>
          </>
        )}
        {card.category === "recipient" && (
          <>
            ...
            {card.fields.doc && <div className="text-ink/30 text-[10px] mt-0.5">{card.fields.doc}</div>}
          </>
        )}
        {card.category === "gate" && (
