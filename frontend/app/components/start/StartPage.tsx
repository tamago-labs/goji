...
const templates = [
  ...
  },
  {
    ...
    description: "Multiple wallets with a multisig gate. Requires signers to approve before payment.",
    cards: [
      { type: "wallet", count: 3 },
      { type: "gate", count: 1 },
      ...
      <main className="max-w-[960px] mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-16">
          ...
          >
            ...
            <span className="font-medium text-ink/70 group-hover:text-ink transition-colors">Blank canvas</span>
          </Link>
