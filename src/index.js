      ...
      const defaultTemplates = [
        {
          ...
          fields: [
            { key: 'company', label: 'Company', type: 'text', autoFill: false, position: 'header' },
          ...
          html: `<html><head><style>body{font-family:'Segoe UI',system-ui,sans-serif;padding:32px;max-width:640px;margin:0 auto;color:#1a1a2e;background:#fafafa}.container{background:#fff;border-radius:12px;padding:32px;box-shadow:0 2px 12px rgba(0,0,0,0.08)}.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid #7FD9B0}.header h1{font-size:22px;color:#1a1a2e;margin:0}.badge{padding:4px 12px;border-radius:20px;font-size:11px;font-weight:600}.badge-paid{background:#7FD9B0;color:#fff}.section{margin:20px 0}.section-title{font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#999;margin-bottom:12px;border-bottom:1px solid #eee;padding-bottom:6px}.row{display:flex;justify-content:space-between;padding:8px 0;border-bottom:1px solid #f0f0f0}.row:last-child{border-bottom:none}.label{color:#666;font-size:13px}.value{font-weight:600;color:#1a1a2e;font-size:13px}.amount-box{background:#f8f9fa;border-radius:8px;padding:16px;margin:16px 0;text-align:center}.amount-box .label{font-size:12px;color:#999;margin-bottom:4px}.amount-box .value{font-size:28px;font-weight:700;color:#1a1a1a}.footer{margin-top:32px;padding-top:16px;border-top:1px solid #eee;font-size:11px;color:#999;text-align:center}</style></head><body><div class="container"><div class="header"><h1>Payment Receipt</h1><span class="badge badge-paid">PAID</span></div><div class="section"><div class="section-title">Payment Details</div><div class="row"><span class="label">Date</span><span class="value">{{date}}</span></div><div class="row"><span class="label">From</span><span class="value">{{sender}}</span></div><div class="row"><span class="label">To</span><span class="value">{{recipient}}</span></div><div class="row"><span class="label">Reference</span><span class="value">{{txHash}}</span></div></div><div class="amount-box"><div class="label">Amount Paid</div><div class="value">{{amount}} USDC</div></div><div class="footer">Generated by Goji</div></div></body></html>`
        },
        {
          name: 'Invoice',
          companyName: identityName,
          ...
          html: `<html><head><style>body{font-family:'Segoe UI',system-ui,sans-serif;padding:32px;max-width:640px;margin:0 auto;color:#1a1a2e;background:#fafafa}.container{background:#fff;border-radius:12px;padding:32px;box-shadow:0 2px 12px rgba(0,0,0,0.08)}.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid #8B7FD6}.header h1{font-size:22px;color:#5A4FB8;margin:0}.badge{padding:4px 12px;border-radius:20px;font-size:11px;font-weight:600}.badge-unpaid{background:#f0f0f0;color:#666}.section{margin:20px 0}.section-title{font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#999;margin-bottom:12px;border-bottom:1px solid #eee;padding-bottom:6px}.row{display:flex;justify-content:space-between;padding:8px 0;border-bottom:1px solid #f0f0f0}.row:last-child{border-bottom:none}.label{color:#666;font-size:13px}.value{font-weight:600;color:#1a1a2e;font-size:13px}.total-box{background:#f0eeff;border-radius:8px;padding:16px;margin:20px 0}.total-box .row{border-bottom:none;padding:4px 0}.total-box .label{color:#5A4FB8}.total-box .value{font-size:20px;font-weight:700;color:#5A4FB8}.footer{margin-top:32px;padding-top:16px;border-top:1px solid #eee;font-size:11px;color:#999;text-align:center}</style></head><body><div class="container"><div class="header"><h1>INVOICE</h1><span class="badge badge-unpaid">UNPAID</span></div><div class="section"><div class="section-title">Bill To</div><div class="row"><span class="label">Company</span><span class="value">{{recipient}}</span></div></div><div class="section"><div class="section-title">From</div><div class="row"><span class="label">Company</span><span class="value">{{sender}}</span></div></div><div class="total-box"><div class="row"><span class="label">Total Due</span><span class="value">{{amount}} USDC</span></div></div><div class="footer">Generated by Goji</div></div></body></html>`
        },
        {
          ...
          html: `<html><head><style>body{font-family:'Segoe UI',system-ui,sans-serif;padding:32px;max-width:640px;margin:0 auto;color:#1a1a2e;background:#fafafa;line-height:1.6}.container{background:#fff;border-radius:12px;padding:32px;box-shadow:0 2px 12px rgba(0,0,0,0.08)}.header{text-align:center;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid #ddd}.header h1{font-size:22px;color:#1a1a2e;margin:0 0 8px}.section{margin:24px 0}.section-title{font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#999;margin-bottom:12px;border-bottom:1px solid #eee;padding-bottom:6px}.party{background:#f8f9fa;border-radius:8px;padding:16px;margin:12px 0}.party .role{font-size:11px;text-transform:uppercase;color:#999;margin-bottom:4px}.party .name{font-weight:600;color:#1a1a2e;font-size:14px}.highlight{background:#f0f0f0;border-radius:8px;padding:16px;margin:16px 0}.highlight .label{font-size:12px;color:#666;margin-bottom:4px}.highlight .value{font-size:18px;font-weight:700;color:#1a1a1a}.footer{margin-top:32px;padding-top:16px;border-top:1px solid #eee;font-size:11px;color:#999;text-align:center}</style></head><body><div class="container"><div class="header"><h1>SERVICE AGREEMENT</h1></div><div class="section"><div class="section-title">Parties</div><div class="party"><div class="role">Client</div><div class="name">{{recipient}}</div></div><div class="party"><div class="role">Service Provider</div><div class="name">{{sender}}</div></div></div><div class="highlight"><div class="label">Total Compensation</div><div class="value">{{amount}} USDC</div></div><div class="footer">Generated by Goji</div></div></body></html>`
        }
      ]
